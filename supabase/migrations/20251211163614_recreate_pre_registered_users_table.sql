/*
  # Recreate Pre-Registered Users Table
  ...
  1. New Tables
    - `pre_registered_users`
      ...
      - `facility_id` (uuid, required) - Link to facility
...
DROP FUNCTION IF EXISTS link_pre_registered_user() CASCADE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    RAISE WARNING 'Error in link_pre_registered_user: %', SQLERRM;
    RETURN NEW;
END;
$$;
