              ...
              /* ========== Account Type Selection ========== */
                ...
                <div>
                  ...
                  <div className="px-8 pt-10 pb-6 text-center">
                    ...
                    <p className="text-slate-500 text-sm">Choose the account type that fits you best</p>
                  </div>
              ...
              /* ========== Login / Signup Form ========== */
                ...
                <div>
                  ...
                  <div className="px-8 pb-8">
                    ...
                    {!isFacilitySignup && (
                      <div className="relative flex p-1 mb-6 bg-slate-100 rounded-xl">
                        <button
                          type="button"
                          onClick={() => {
                            setIsLogin(true);
                          ...
                          className={`relative flex-1 py-2 text-sm font-semibold transition-all rounded-lg ${
                      ...
                      <>
                        <div className="grid grid-cols-2 gap-3 mb-5">
                          <motion.button
                            ...
                            disabled={loading}
                            className="bg-black hover:bg-black/90 border border-black rounded-xl py-3 font-medium text-white flex items-center justify-center gap-2.5 transition-colors disabled:opacity-50"
                          >
                          ...
                          <motion.button
                            ...
                            disabled={loading}
                            className="bg-white border border-slate-200 rounded-xl py-3 hover:bg-slate-50/50 font-medium text-slate-700 flex items-center justify-center gap-2.5 transition-colors disabled:opacity-50"
                          >
