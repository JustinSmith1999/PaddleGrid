...
export default function AchievementsShowcase({
  ...
  const getRarityBorder = (rarity: string) => {
    switch (rarity) {
      case 'legendary': return 'border-yellow-400 shadow-lg shadow-yellow-400/30';
      case 'epic': return 'border-purple-400 shadow-lg shadow-purple-400/30';
      case 'rare': return 'border-blue-400 shadow-lg shadow-blue-400/30';
      case 'uncommon': return 'border-green-400 shadow-lg shadow-green-400/30';
    ...
    return (
      <div className="bg-white rounded-xl shadow-sm p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-bold text-gray-900">Featured Achievements</h3>
        ...
        <div className="grid grid-cols-3 gap-3">
          {featuredAchievements.map(achievement => {
            ...
            return (
              <div
                key={achievement.id}
                className={`relative bg-gradient-to-br ${getRarityColor(achievement.rarity)} p-4 rounded-xl text-center group hover:scale-105 transition-transform cursor-pointer`}
              >
        ...
        <div className="mt-4 pt-4 border-t border-gray-200 flex items-center justify-between text-sm">
          ...
          <span className="font-bold text-yellow-600">{stats.points.toLocaleString()}</span>
        </div>
      </div>
    );
  }
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          <div className="bg-gradient-to-br from-yellow-50 to-amber-50 rounded-lg p-4 text-center">
            ...
            <div className="text-2xl font-bold text-gray-900">{stats.unlocked}</div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg p-4 text-center">
            ...
            <div className="text-2xl font-bold text-gray-900">{stats.points.toLocaleString()}</div>
