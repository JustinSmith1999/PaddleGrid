import { ArrowLeft, Mail, MessageSquare, HelpCircle, ExternalLink } from 'lucide-react';
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-4">
          {[
            ...
            { q: 'How do I list my venue on PaddleGrid?', a: 'Click "I run a venue" on the homepage or sign up as a facility operator. You\'ll get access to our venue management dashboard where you can add courts, set pricing, and manage bookings.' },
            { q: 'Is my payment information secure?', a: 'Yes. All payments are processed through Stripe, a PCI Level 1 certified payment processor. We never store your full card number on our servers.' },
