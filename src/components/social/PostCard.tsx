...
export default function PostCard({ post, onClick, onUpdate, onClubClick, onProfileClick }: PostCardProps) {
  ...
  return (
    ...
    <div
      onClick={onClick}
      className="bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors cursor-pointer p-4 border border-slate-200 dark:border-slate-800 rounded-xl h-full flex flex-col"
    >
