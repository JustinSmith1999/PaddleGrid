    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center p-4">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-xl font-semibold text-slate-900 mb-2">Taking longer than expected</h2>
          <p className="text-slate-500 mb-4">Please check your internet connection and try again.</p>
          <button
            onClick={() => window.location.reload()}
            className="px-6 py-3 bg-green-700 text-white rounded-xl hover:bg-green-800 transition-colors font-semibold"
          >
            Reload App
          </button>
        </div>
