// Vercel Edge Middleware — gates the entire site behind HTTP Basic Auth.
...
export default function middleware(request: Request): Response | undefined {
  ...
  if (!expectedUser || !expectedPass) {
    return new Response('Site is temporarily restricted', { status: 503 });
  }
...
function unauthorized(): Response {
  return new Response('Authentication required', {
    status: 401,
    headers: {
      'WWW-Authenticate': 'Basic realm="PaddleGrid", charset="UTF-8"',
